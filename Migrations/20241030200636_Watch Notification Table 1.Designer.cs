...
namespace AuctionManagementAPI.Migrations
{
    ...
    [Migration("20241030200636_Watch Notification Table 1")]
    partial class WatchNotificationTable1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserWatchAuction", b =>
                {
                    b.Property<int>("UsersUserId")
                        .HasColumnType("int");

                    b.Property<int>("WatchAuctionsWatchAuctionId")
                        .HasColumnType("int");

                    b.HasKey("UsersUserId", "WatchAuctionsWatchAuctionId");

                    b.HasIndex("WatchAuctionsWatchAuctionId");

                    b.ToTable("UserWatchAuctions", (string)null);
                });
            ...
            modelBuilder.Entity("UserWatchAuction", b =>
                {
                    b.HasOne("AuctionManagementAPI.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UsersUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AuctionManagementAPI.Models.WatchAuction", null)
                        .WithMany()
                        .HasForeignKey("WatchAuctionsWatchAuctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
